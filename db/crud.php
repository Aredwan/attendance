    ...
    class crud{
        ...
        public function insertAttendees($fname, $lname, $dob, $email, $phone, $specialty){
            try {
                ...
                VALUES (:fname,:lname,:dob,:email,:phone,:specialty)";
        ...
        public function editAttendee($id,$fname, $lname, $dob, $email,$phone,$specialty){
            try{ 
                 $sql = "UPDATE `attendee` SET `firstname`=:fname,`lastname`=:lname,`dateofbirth`=:dob,`email`=:email,`contactnumber`=:phone,`specialty_id`=:specialty WHERE attendee_id = :id ";
                 $stmt = $this->db->prepare($sql);
